                                ...
                                <CardBody>
                                    ...
                                    <div className="scroll-area-lg scroll-area">
                                        <div className="scrollable-block">
                                            <Sticky boundaryElement=".scrollable-block" scrollElement=".scroll-area"
                                                    hideOnBoundaryHit={false}>
                                                <div className="dropdown-menu-header m-0">
                                                    <div className="dropdown-menu-header-inner m-0 rounded bg-primary">
                                                        <div className="menu-header-content">
                                                            <h5 className="menu-header-title">Scrollable Header</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </Sticky>
                                ...
                                <CardBody>
                                    ...
                                    <div className="scroll-area-lg scroll-area">
                                        <div className="scrollable-block">
                                            ...
                                            <Sticky mode="bottom" boundaryElement=".scrollable-block"
                                                    scrollElement=".scroll-area"
                                                    hideOnBoundaryHit={false}>
                                                <div className="dropdown-menu-header m-0">
                                                    <div className="dropdown-menu-header-inner m-0 rounded bg-focus">
                                                        <div className="menu-header-content">
                                                            <h5 className="menu-header-title">Scrollable Footer</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </Sticky>
