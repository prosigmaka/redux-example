                                ...
                                <CardBody>
                                    ...
                                    <ResponsiveContainer width='100%' aspect={4.0 / 3.0}>
                                        <BarChart data={data1}>
                                            ...
                                            <YAxis/>
                                            <CartesianGrid strokeDasharray="3 3"/>
                                            <Bar dataKey="female" fill="#fece78" shape={<TriangleBar/>}
                                                 label={{position: 'top'}}>
                                                {
                                ...
                                <CardBody>
                                    ...
                                    <ResponsiveContainer width='100%' aspect={4.0 / 3.0}>
                                        <AreaChart data={data}>
                                            ...
                                            <YAxis/>
                                            <Tooltip/>
                                            <Area type='monotone' dataKey='uv' stackId="1" stroke='#fece78'
                                                  fill='#fece78'/>
                                            <Area type='monotone' dataKey='pv' stackId="1" stroke='#82ca9d'
                                                  fill='#82ca9d'/>
                                            <Area type='monotone' dataKey='amt' stackId="1" stroke='#ffc658'
                                                  fill='#ffc658'/>
                                        </AreaChart>
                                    </ResponsiveContainer>
                                </CardBody>
                                ...
                                <CardBody>
                                    ...
                                    <ResponsiveContainer width='100%' aspect={4.0 / 3.0}>
                                        <AreaChart data={data3} stackOffset="expand">
                                            ...
                                            <Area type='monotone' dataKey='a' stackId="1" stroke='#fece78'
                                                  fill='#fece78'/>
                                            <Area type='monotone' dataKey='b' stackId="1" stroke='#82ca9d'
                                                  fill='#82ca9d'/>
                                            <Area type='monotone' dataKey='c' stackId="1" stroke='#ffc658'
                                                  fill='#ffc658'/>
                                        </AreaChart>
                                    </ResponsiveContainer>
                                </CardBody>
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <ResponsiveContainer width='100%' aspect={4.0 / 3.0}>
                                        <PieChart>
                                            <Pie data={data001} cx='50%' cy= '50%' outerRadius={60} fill="#fece78"/>
                                            <Pie data={data002} cx='50%' cy='50%' innerRadius={70} outerRadius={90}
                                                 fill="#82ca9d" label/>
                                        </PieChart>
                                    </ResponsiveContainer>
                                </CardBody>
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <ResponsiveContainer width='100%' aspect={4.0 / 3.0}>
                                        <RadialBarChart width={150} 
                                                height={150} innerRadius={20} outerRadius={140}
                                                        barSize={10} data={data5}>
