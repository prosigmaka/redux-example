        ...
        return (
            <Fragment>
                <div className="text-center mb-3">
                    <Button color="primary" onClick={this.updateCharts}>Update!</Button>
                </div>
                <Row>
                    <Col md="6">
                        <Chart options={this.state.optionsMixedChart} series={this.state.seriesMixedChart} type="line" width="100%"/>
                    </Col>
                    <Col md="6">
                        <Chart options={this.state.optionsRadial} series={this.state.seriesRadial} type="radialBar" width="280"/>
                        <div className="divider"/>
                        <Chart options={this.state.optionsBar} height={140} series={this.state.seriesBar} type="bar" width={'100%'}/>
                    </Col>
                </Row>
            </Fragment>
        );
