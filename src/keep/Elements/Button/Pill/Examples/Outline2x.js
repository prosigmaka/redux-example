                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill"
                                            color="primary">Primary</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" color="secondary">Secondary</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill"
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" active
                                            color="primary">Primary</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" active
                                    ...
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" active
                                            color="warning">Warning</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" active color="danger">Danger</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" active
                                            color="focus">Focus</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" active
                                            color="alternate">Alt</Button>
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" disabled
                                            color="primary">Primary</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" disabled
                                            color="secondary">Secondary</Button>
                                    <Button outline className="mb-2 mr-2 btn-outline-2x btn-pill" disabled
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button outline block className="mb-2 mr-2 btn-outline-2x btn-pill" size="lg"
                                            color="primary">Block
                                        Large</Button>
                                    <Button outline block className="mb-2 mr-2 btn-outline-2x btn-pill" color="primary">Block
                                        Normal</Button>
                                    <Button outline block className="mb-2 mr-2 btn-outline-2x btn-pill" size="sm"
                                            color="primary">Block
                                        Small</Button>
                                </CardBody>
                            </Card>
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <div className="text-center">
                                        <Button outline className="btn-wide btn-outline-2x mb-2 mr-2 btn-pill" size="lg"
                                                color="primary">Wider
                                            Large</Button>
                                        <Button outline className="btn-wide btn-outline-2x mb-2 mr-2 btn-pill"
                                                color="primary">Wider Normal</Button>
                                        <Button outline className="btn-wide btn-outline-2x mb-2 mr-2 btn-pill" size="sm"
                                                color="primary">Wider
                                            Small</Button>
                                    </div>
                                </CardBody>
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <div className="text-center">
                                        <Button outline className="btn-outline-2x mb-2 mr-2 btn-pill" size="lg"
                                                color="primary">Large</Button>
                                        <Button outline className="btn-outline-2x mb-2 mr-2 btn-pill"
                                                color="primary">Normal</Button>
                                        <Button outline className="btn-outline-2x mb-2 mr-2 btn-pill" size="sm"
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Row className="text-center">
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-primary"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-secondary"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-focus"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-alternate"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-light"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-dark"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-danger"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-warning"
                                    ...
                                    <Row className="text-center">
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-success"
                                        ...
                                        <Col md="3">
                                            <LaddaButton
                                                className="mb-2 mr-2 btn btn-pill btn-outline-2x btn-outline-info"
...
export default ButtonsPillOutline2x;
