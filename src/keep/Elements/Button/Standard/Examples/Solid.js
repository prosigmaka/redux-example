                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Row className="text-center">
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-secondary"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-focus"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-alternate"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-light"
                                    ...
                                    <Row className="text-center">
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-success"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-info"
