                        ...
                        <Col xl="6" lg="12">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="secondary">
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="warning">
                                        <i className="pe-7s-trash btn-icon-wrapper"> </i>
                                        Warning
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="danger">
                                        <i className="pe-7s-video btn-icon-wrapper"> </i>
                                        Danger
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="focus">
                                        <i className="pe-7s-upload btn-icon-wrapper"> </i>
                                        Focus
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="alternate">
                                        <i className="pe-7s-piggy btn-icon-wrapper"> </i>
                                        Alt
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="light">
                                        <i className="pe-7s-photo btn-icon-wrapper"> </i>
                                        Light
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="dark">
                                        <i className="pe-7s-helm btn-icon-wrapper"> </i>
                                        Dark
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" color="link">
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-transition" outline
                                            color="primary">
                                        <i className="pe-7s-tools btn-icon-wrapper"> </i>
                                        Primary
                                    </Button>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-transition" outline color="info">
                                        <i className="pe-7s-science btn-icon-wrapper"> </i>
                                        Info
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-transition" outline
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-transition" outline color="dark">
                                        <i className="pe-7s-helm btn-icon-wrapper"> </i>
                                        Dark
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-transition" outline color="link">
                                        <i className="pe-7s-settings btn-icon-wrapper"> </i>
                                        link
                                    </Button>
                                </CardBody>
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="primary">
                                        <i className="pe-7s-tools btn-icon-wrapper"> </i>
                                        Primary
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="secondary">
                                        <i className="pe-7s-gym btn-icon-wrapper"> </i>
                                        Secondary
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="success">
                                        <i className="pe-7s-umbrella btn-icon-wrapper"> </i>
                                        Success
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="info">
                                        <i className="pe-7s-science btn-icon-wrapper"> </i>
                                        Info
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="warning">
                                        <i className="pe-7s-trash btn-icon-wrapper"> </i>
                                        Warning
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="danger">
                                        <i className="pe-7s-video btn-icon-wrapper"> </i>
                                        Danger
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="focus">
                                        <i className="pe-7s-upload btn-icon-wrapper"> </i>
                                        Focus
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="alternate">
                                        <i className="pe-7s-piggy btn-icon-wrapper"> </i>
                                        Alt
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="light">
                                        <i className="pe-7s-photo btn-icon-wrapper"> </i>
                                        Light
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="dark">
                                        <i className="pe-7s-helm btn-icon-wrapper"> </i>
                                        Dark
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical" outline color="link">
                                        <i className="pe-7s-settings btn-icon-wrapper"> </i>
                                        link
                                    </Button>
                                </CardBody>
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-shadow btn-dashed" outline
                                            color="primary">
                                        <i className="pe-7s-tools btn-icon-wrapper"> </i>
                                        Primary
                                    </Button>
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button block className="mb-2 mr-2 btn-icon-vertical" size="lg" color="primary">
                                        <i className="lnr-picture btn-icon-wrapper"> </i>
                                        Block Large
                                    </Button>
                                    <Button block className="mb-2 mr-2 btn-icon-vertical" color="primary">
                                        <i className="lnr-crop btn-icon-wrapper"> </i>
                                        Block Normal
                                    </Button>
                                    <Button block className="mb-2 mr-2 btn-icon-vertical" size="sm" color="primary">
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <div className="text-center">
                                        <Button className="btn-wide mb-2 mr-2 btn-icon-vertical" size="lg"
                                                color="primary">
                                            <i className="pe-7s-science btn-icon-wrapper"> </i>
                                            Large
                                        </Button>
                                        <Button className="btn-wide mb-2 mr-2 btn-icon-vertical" color="primary">
                                            <i className="pe-7s-volume btn-icon-wrapper"> </i>
                                            Normal
                                        </Button>
                                        <Button className="btn-wide mb-2 mr-2 btn-icon-vertical" size="sm"
                                                color="primary">
                                            <i className="pe-7s-tools btn-icon-wrapper"> </i>
                                            Small
                                        </Button>
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <div className="text-center">
                                        <Button className="btn-wide mb-2 mr-2 btn-icon-vertical btn-icon-bottom"
                                                size="lg"
                                                color="warning">
                                            Large
                                            <i className="pe-7s-science btn-icon-wrapper"> </i>
                                        ...
                                        <Button
                                            className="btn-wide mb-2 mr-2 btn-icon-vertical btn-icon-bottom btn-shadow"
                                            outline color="success">
                                            Normal
                                            <i className="pe-7s-volume btn-icon-wrapper"> </i>
                                        </Button>
                                        <Button
                                            className="btn-wide mb-2 mr-2 btn-icon-vertical btn-icon-bottom btn-dashed"
                        ...
                        <Col xl="6" lg="12">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="primary">
                                        <i className="lnr-license btn-icon-wrapper"> </i>
                                        Primary
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="secondary">
                                        <i className="lnr-map btn-icon-wrapper"> </i>
                                        Secondary
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="success">
                                        <i className="lnr-music-note btn-icon-wrapper"> </i>
                                        Success
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="info">
                                        <i className="lnr-heart btn-icon-wrapper"> </i>
                                        Info
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="warning">
                                        <i className="lnr-magic-wand btn-icon-wrapper"> </i>
                                        Warning
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="danger">
                                        <i className="lnr-lighter btn-icon-wrapper"> </i>
                                        Danger
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="focus">
                                        <i className="lnr-dice btn-icon-wrapper"> </i>
                                        Focus
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="alternate">
                                        <i className="lnr-apartment btn-icon-wrapper"> </i>
                                        Alt
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="light">
                                        <i className="lnr-database btn-icon-wrapper"> </i>
                                        Light
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="dark">
                                        <i className="lnr-location btn-icon-wrapper"> </i>
                                        Dark
                                    </Button>
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-square" color="link">
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-transition border-0"
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-icon-vertical btn-shadow btn-outline-2x" outline
                                            color="primary">
