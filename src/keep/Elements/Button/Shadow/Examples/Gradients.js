                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button className="mb-2 mr-2 btn-shadow-primary btn-gradient-primary"
                                            color="primary">Primary</Button>
                                    <Button className="mb-2 mr-2 btn-shadow-secondary btn-gradient-secondary"
                                            color="secondary">Secondary</Button>
                                    <Button className="mb-2 mr-2 btn-shadow-success btn-gradient-success"
                                            color="success">Success</Button>
                                    <Button className="mb-2 mr-2 btn-shadow-info btn-gradient-info"
                                            color="info">Info</Button>
                                    <Button className="mb-2 mr-2 btn-shadow-warning btn-gradient-warning"
                                    ...
                                    <Button className="mb-2 mr-2 btn-shadow-alternate btn-gradient-alternate"
                                            color="alternate">Alt</Button>
                                    <Button className="mb-2 mr-2 btn-shadow-light btn-gradient-light" color="light">Light</Button>
                                    <Button className="mb-2 mr-2 btn-shadow-dark btn-gradient-dark"
                                            color="dark">Dark</Button>
                                    <Button className="mb-2 mr-2 btn-shadow-link btn-gradient-link"
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button active
                                            className="mb-2 mr-2 btn-shadow btn-gradient-primary">Primary</Button>
                                    <Button active
                                            className="mb-2 mr-2 btn-shadow btn-gradient-secondary">Secondary</Button>
                                    <Button active
                                            className="mb-2 mr-2 btn-shadow btn-gradient-success">Success</Button>
                                    <Button active className="mb-2 mr-2 btn-shadow btn-gradient-info">Info</Button>
                                    <Button active
                                            className="mb-2 mr-2 btn-shadow btn-gradient-warning">Warning</Button>
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button disabled
                                            className="mb-2 mr-2 btn-shadow btn-gradient-warning">Warning</Button>
                                    <Button disabled
                                            className="mb-2 mr-2 btn-shadow btn-gradient-danger">Danger</Button>
                                    <Button disabled className="mb-2 mr-2 btn-shadow btn-gradient-focus">Focus</Button>
                                    <Button disabled
                                            className="mb-2 mr-2 btn-shadow btn-gradient-alternate">Alt</Button>
                        ...
                        <Col lg="6">
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Button block className="mb-2 mr-2 btn-shadow btn-gradient-primary" size="lg">Block
                                        Large</Button>
                                    <Button block className="mb-2 mr-2 btn-shadow btn-gradient-primary">Block
                                        Normal</Button>
                                    <Button block className="mb-2 mr-2 btn-shadow btn-gradient-primary" size="sm">Block
                                        Small</Button>
                                </CardBody>
                            </Card>
                        </Col>
                                ...
                                <CardBody>
                                    ...
                                    <div className="text-center">
                                        <Button className="btn-wide mb-2 mr-2 btn-shadow btn-gradient-primary"
                                                size="lg">Wider
                                            Large</Button>
                                        <Button className="btn-wide mb-2 mr-2 btn-shadow btn-gradient-primary">Wider
                                            Normal</Button>
                                        <Button className="btn-wide mb-2 mr-2 btn-shadow btn-gradient-primary"
                                                size="sm">Wider
                                            Small</Button>
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <Button
                                            className="btn-wide mb-2 mr-2 btn-shadow btn-gradient-primary">Normal</Button>
                                        <Button className="btn-wide mb-2 mr-2 btn-shadow btn-gradient-primary"
                            ...
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <Row className="text-center">
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-primary"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-secondary"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-focus"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-alternate"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-light"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-dark"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-danger"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-warning"
                                    ...
                                    <Row className="text-center">
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-success"
                                        ...
                                        <Col md="3">
                                            <LaddaButton className="mb-2 mr-2 btn btn-shadow btn-gradient-info"
