...
import {
    Row, Col,
    Card, CardBody, DropdownToggle, DropdownItem, DropdownMenu,
    ListGroup, ListGroupItem, Dropdown,
    ButtonGroup, CardHeader, CustomInput, CardFooter,
                                    ...
                                    <ListGroup flush>
                                                    ...
                                                    <div className="widget-content-right">
                                                        <ButtonGroup size="sm">
                                                            <Button className="btn-shadow" color="primary"
                                                                    ...
                                                                    active={this.state.cSelected.includes(1)}>Hire</Button>
                                                            <Button className="btn-shadow" color="primary"
                                                                    onClick={() => this.onCheckboxBtnClick(3)}
                                                                    active={this.state.cSelected.includes(3)}>Fire</Button>
                                                        </ButtonGroup>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <ListGroupItem>
                                            <div className="widget-content p-0">
                                                <div className="widget-content-wrapper">
                                                    <div className="widget-content-left mr-3">
                                                        <img width={42} className="rounded-circle" src={avatar3}
                                                             alt=""/>
                                                    </div>
                                                    <div className="widget-content-left">
                                                        <div className="widget-heading">
                                                    ...
                                                    <div className="widget-content-right">
                                                        <Button className="btn-pill btn-hover-shine" size="sm"
                                                                color="focus">Details</Button>
                                                    </div>
                                                </div>
                                            </div>
                                        </ListGroupItem>
                                        <ListGroupItem>
                                            <div className="widget-content p-0">
                                                <div className="widget-content-wrapper">
                                                    <div className="widget-content-left mr-3">
                                                        <img width={42} className="rounded-circle" src={avatar4}
                                                             alt=""/>
                                                    </div>
                                                    <div className="widget-content-left">
                                                        <div className="widget-heading">
                                        ...
                                        <ListGroupItem>
                                            <div className="widget-content p-0">
                                                <div className="widget-content-wrapper">
                                                    <div className="widget-content-left mr-3">
                                                        <img width={42} className="rounded-circle" src={avatar5}
                                                             alt=""/>
                                                    </div>
                                                    <div className="widget-content-left">
                                                        <div className="widget-heading">
                                                    ...
                                                    <div className="widget-content-right">
                                                        <div className="ml-auto badge badge-pill badge-warning">43</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </ListGroupItem>
                                            ...
                                            <ListGroupItem>
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-right">
                                                            <div className="ml-auto badge badge-pill badge-warning">43
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <ListGroupItem>
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        <div className="widget-content-left mr-3">
                                                            <div className="widget-content-left">
                                                                <img width={52} className="rounded" src={avatar6}
                                                                     alt=""/>
                                                            </div>
                                                        </div>
                                                        <div className="widget-content-left flex2">
