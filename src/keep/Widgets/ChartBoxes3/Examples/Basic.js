                            ...
                            <Col lg="6" xl="4">
                                <div className="card mb-3 widget-content">
                                    <div className="widget-content-outer">
                                        ...
                                        <div className="widget-progress-wrapper">
                                            <Progress className="progress-bar-lg progress-bar-animated" color="warning"
                                                      value="47"/>
                                            <div className="progress-sub-label">
                                                <div className="sub-label-left">
                                                    Retention
                                        ...
                                        <ListGroupItem>
                                            <div className="widget-content p-0">
                                                <div className="widget-content-outer">
                                                    ...
                                                    <div className="widget-progress-wrapper">
                                                        <Progress className="progress-bar-xs" color="primary"
                                                                  value="65"/>
                                                        <div className="progress-sub-label">
                                                            <div className="sub-label-left">
                                                                YoY Growth
                                        ...
                                        <ListGroupItem>
                                            <div className="widget-content p-0">
                                                <div className="widget-content-outer">
                                                    ...
                                                    <div className="widget-progress-wrapper">
                                                        <Progress className="progress-bar-lg progress-bar-animated"
                                                                  color="warning" value="47"/>
                                                        <div className="progress-sub-label">
                                                            <div className="sub-label-left">
                                                                Retention
                                                            </div>
