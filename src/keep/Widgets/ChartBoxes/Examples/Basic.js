...
import {IoIosCar, IoIosFilm} from "react-icons/io";
// import Ionicon from 'react-ionicons';
import {faAngleDown, faAngleUp, faArrowLeft, faArrowRight, faEllipsisH,} from '@fortawesome/free-solid-svg-icons';
                                ...
                                <div className="card mb-3 widget-chart">
                                    <div className="icon-wrapper rounded">
                                        ...
                                        <div className="center-svg">
                                            <IoIosCar color="#333333" fontSize="2rem" />
                                        </div>
                                    </div>
                                    <div className="widget-numbers">
                                        <CountUp start={0}
