                                        ...
                                        <div className="btn-actions-pane-right">
                                            <ButtonGroup size="sm">
                                                <Button caret="true" color="dark"
                                                        className={"btn-shadow " + classnames({active: this.state.activeTab2 === '222'})}
                                                        onClick={() => {
                                                            this.toggle2('222');
                                                        }}
                                                >Last Month</Button>
                                                <Button color="dark"
                                                        className={"btn-shadow " + classnames({active: this.state.activeTab2 === '111'})}
                                                        onClick={() => {
                                                            this.toggle2('111');
                                                        }}
                            ...
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    <CardHeader className="card-header-tab">
                                        <div
                                            className="card-header-title font-size-lg text-capitalize font-weight-normal">
                                            <i className="header-icon lnr-music-note mr-3 text-muted opacity-6"> </i>
                                            Technical Support
                                        </div>
                                    </CardHeader>
                        ...
                        <Row>
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    <CardHeader className="h-auto p-3">
                                        <div>
                                            <h5 className="menu-header-title text-capitalize">Sales</h5>
                                            <h6 className="menu-header-subtitle text-capitalize opacity-8">Total sales for this year</h6>
                                        </div>
                                        <div className="btn-actions-pane-right">
                                            <UncontrolledButtonDropdown>
                                                <DropdownToggle caret size="sm" className="btn-icon btn-icon-only"
                                                                color="dark">
                                            ...
                                            <Col md="4">
                                                <div className="widget-chart d-flex align-self-center he-100 p-0">
                                                    <div className="widget-chart-content mx-auto center-elem">
                                                        <div
                                                            className="widget-numbers text-success fsize-4">
                                                            <div>
                                                        <span className="opacity-10 text-success pr-2">
                                                            <FontAwesomeIcon icon={faAngleUp}/>
                                                        </span>
                                            ...
                                            <Col md="8">
                                                <div className="widget-chart-wrapper chart-wrapper-relative">
                                                    <ResponsiveContainer height={250}>
                                                        <AreaChart data={data3333}
                                                                   margin={{top: 0, right: 0, left: 0, bottom: 0}}>

                                                            <defs>
                                                                <linearGradient id="colorUv" x1="0" y1="0" x2="0"
                                                                                y2="1">
                                                                    <stop offset="5%" stopColor="#f5d7ea"
                                                                          stopOpacity={0}/>
                                                                    <stop offset="95%" stopColor="#f5d7ea"
                                                                          stopOpacity={0.8}/>
                                                                </linearGradient>
                                                            </defs>
                                                            <Tooltip/>
                                                            <Area type='monotone' dataKey='uv' stroke='#e570b9'
                                ...
                                <Card className="mb-3">
                                    <CardHeader className="h-auto p-3">
                                        <div>
                                            <h5 className="menu-header-title text-capitalize">Servers</h5>
                                            <h6 className="menu-header-subtitle text-capitalize opacity-8">Live
                                                servers statistics</h6>
                                        </div>
                                        <div className="btn-actions-pane-right">
                                            <Button size="sm" onClick={this.togglePop} id="PopoverEx1"
                                                    className="btn-icon btn-icon-only" color="dark">
                                                <div className="btn-icon-wrapper">
                                                    <FontAwesomeIcon icon={faBars}/>
                                                </div>
                                            </Button>

                                            <Popover className="popover-custom" placement="bottom-start"
                                                     isOpen={this.state.popoverOpen} target="PopoverEx1"
                                                    ...
                                                    <div className="dropdown-menu-header">
                                                        <div className="dropdown-menu-header-inner bg-primary">
                                                            ...
                                                            <div className="menu-header-content">
                                                                ...
                                                                <h6 className="menu-header-subtitle">Manage all of
                                                                    your
                                                                    options</h6>
                                                            </div>
                                                        </div>
                                        ...
                                        <Row>
                                            <Col md="4">
                                                <div className="widget-chart d-flex align-self-center he-100 p-0">
                                                    <div className="widget-chart-content mx-auto center-elem">
                                                        <div
                                                            className="widget-numbers text-danger fsize-4">
                                                            <small className="text-muted opacity-5 pr-1">
                                                                $
                                                            </small>
                                                            2.2M
                                                        </div>
                            ...
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    <CardHeader className="h-auto p-3">
                                        <div>
                                            <h5 className="menu-header-title text-capitalize">Performance</h5>
                                            <h6 className="menu-header-subtitle text-capitalize opacity-8">Current portfolio state</h6>
                                        </div>
                                        <div className="btn-actions-pane-right">
                                            <UncontrolledButtonDropdown>
                                                <DropdownToggle size="sm" caret className="btn-icon btn-icon-only"
                                                                color="dark">
                                                    <div className="btn-icon-wrapper">
                                                        <FontAwesomeIcon icon={faBars}/>
                                                    </div>
                                                ...
                                                <div className="chart-wrapper">
                                                    <ResponsiveContainer height={250}>
                                                        <BarChart data={data222}>
                                                            <Bar barGap="55" dataKey="Sales" stackId="a"
                                                                 fill="#58a90f"/>
                                                            <Bar barGap="55" dataKey="Downloads" stackId="a"
                                                                 fill="#ecffda"/>
                                                        </BarChart>
                                                    </ResponsiveContainer>
                                                </div>
                                            ...
                                            <div className="widget-content p-0">
                                                <div className="widget-chart-actions">
                                                    <UncontrolledButtonDropdown>
                                                        ...
                                                        <DropdownMenu
                                                            className="dropdown-menu-lg rm-pointers dropdown-menu-right">
                                                            <div className="dropdown-menu-header">
                                                                <div className="dropdown-menu-header-inner bg-primary">
                                                                    ...
                                                                    <div className="menu-header-content">
                                                                        <div>
                                                                            <h5 className="menu-header-title">
                                                                                Settings</h5>
                                                                            <h6 className="menu-header-subtitle">Manage
                                                                                all
                                                                                of
                                                                                your options</h6>
                                                                        </div>
                                    ...
                                    <TabContent activeTab={this.state.activeTab}>
                                        <TabPane tabId="1">
                                            <CardBody>
                                                ...
                                                <h6 className="menu-header-subtitle">Total performance for this
                                                    month</h6>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col sm="12" md="6">
                                                            <div className="widget-chart">
                                                                <div className="widget-chart-content">
                                                                    <div
                                                                        className="widget-numbers text-info fsize-3">
                                                                        12.31k
                                                                    </div>
                                                                    <div className="widget-subheading pt-1">
                                                                        Page Views
