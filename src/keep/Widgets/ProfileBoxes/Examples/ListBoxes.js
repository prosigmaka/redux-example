                        ...
                        <Row>
                            ...
                            <Col md="12" lg="6" xl="4">
                                <Card className="card-shadow-primary card-border mb-3">
                                    ...
                                    <CardFooter className="text-center d-block">
                                        <Button outline className="mr-2 border-0 btn-transition" color="danger">Remove
                                            from
                                            list</Button>
                                        <Button outline className="border-0 btn-transition" color="success">Send
                                            Message</Button>
                                    </CardFooter>
                                </Card>
                            </Col>
                                        ...
                                        <div className="dropdown-menu-header-inner bg-danger">
                                            ...
                                            <div className="menu-header-content btn-pane-right">
                                                ...
                                                <div>
                                                    ...
                                                    <h6 className="menu-header-subtitle">Sales Manager</h6>
                                                </div>
                                                <div className="menu-header-btn-pane">
                        ...
                        <Row>
                            <Col md="12" lg="6" xl="4">
                                        ...
                                        <div className="dropdown-menu-header-inner bg-focus">
                                            ...
                                            <div className="menu-header-content btn-pane-right">
                                                ...
                                                <div>
                                                    ...
                                                    <h6 className="menu-header-subtitle">Implementation Specialist</h6>
                                                </div>
                                                <div className="menu-header-btn-pane">
                                                    <LaddaButton className="btn btn-pill btn-dark"
                                                                 loading={this.state.expSlideRight}
                                                                 onClick={() => this.toggle2('expSlideRight')}
                                ...
                                <Card className="card-shadow-primary profile-responsive card-border mb-3">
                                    ...
                                    <TabContent activeTab={this.state.activeTab}>
                                        ...
                                        <TabPane tabId="2">
                                            <div className="p-3">
                                                <p className="mb-0">With supporting text below as a natural lead-in to
                                                    additional
                                                    content.</p>
                                            </div>
                                        </TabPane>
                                                        ...
                                                        <div className="widget-content-right">
                                                            <div className="font-size-xlg text-muted">
                                                                ...
                                                                <CountUp start={0}
                                                                         ...
                                                                         prefix=""
                                                                         duration="15"/>
                                                                <small className="text-info pl-2">
                                                                    <FontAwesomeIcon icon={faAngleUp}/>
                                                                </small>
                                                            </div>
                                                        </div>
                            ...
                            <Col md="12" lg="6" xl="4">
                                <Card className="card-shadow-primary card-border text-white mb-3" color="primary">
                                        ...
                                        <div className="dropdown-menu-header-inner bg-primary">
                                            <div className="menu-header-content">
                                                ...
                                                <div>
                                                    ...
                                                    <h6 className="menu-header-subtitle">Applications Technician</h6>
                                                </div>
                                                <div className="menu-header-btn-pane pt-1">
                                                    <Button size="sm" className="btn-icon"
                                                            color="dark">
                                    ...
                                    <CardFooter className="text-center d-block">
                                        <Button className="btn-shadow-dark btn-wider" color="dark">Send
                                            Message</Button>
                                    </CardFooter>
                                </Card>
